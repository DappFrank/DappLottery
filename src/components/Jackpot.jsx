      ...
      <div className="flex items-center justify-center py-20 flex-wrap">
        <div className="min-w-64 min-h-60 rounded-lg bg-white m-2 px-5 py-7 ">
          <div className="flex items-center pb-5">
            <div>
              <img className="rounded-lg w-20" src={octupus} alt="icon" />
            </div>
            <div>
          ...
          <div className="pb-6">
            ...
            <p className="text-sm leading-5 text-gray-500">
              We bring persolan and effective to every <br /> project we work
        ...
        <div className="min-w-64 min-h-60 rounded-lg bg-white m-2 px-5 py-7">
          <div className="flex items-center pb-5">
            <div>
              <img className="rounded-lg w-20" src={turtle} alt="icon" />
            </div>
            <div>
              <p className="text-green-300">$181,557,581</p>
              <p className="text-sm text-gray-500">Next Draw: 03 days 04:21</p>
        ...
        <div className="min-w-64 min-h-60 rounded-lg bg-white m-2 px-5 py-7">
          <div className="flex items-center pb-5">
            <div>
              <img className="rounded-lg w-20" src={leopard} alt="icon" />
            </div>
            <div>
              <p className="text-green-300">$181,557,581</p>
              <p className="text-sm text-gray-500">Next Draw: 03 days 04:21</p>
